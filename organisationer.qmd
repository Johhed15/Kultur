...
for(r in sort(kommuner)){
  ...
  cat('<img src="', filename_svg, '" alt= "',paste("Figuren visar antal deltagare per studietimme och genomsnittlig studietid för studieverksamheterna över tid i",r), '" style="width:100%; max-width:800px; height:100%;">\n', sep = "")
