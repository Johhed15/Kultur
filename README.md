...
-   Här hittas också kommentarer om eventuell manuell nedladdning av filer vilket för denna rapport är:
    ...
    -   Inloggning till MONA krävs för att sammanställa och ladda ned datasetet: 
    
    -   Tillgång till SCBs företagsregister-API krävs för att sammanställa och ladda ned datasetet:
